 ...
 *
 * Именно из-за этого образ и CI переведены на Node 24 (bt#201): под 22 путь потока был нерабочим
 * целиком, а не только в тестах. Условие оставлено не как заглушка, а как страховка — если версию
 * когда-нибудь откатят, гейт не начнёт молча врать зелёным, он назовёт причину и не запустится.
 */
