...
/** Временный bundleDir с одним module/index.js (self-contained ESM). */
function writeBundle(source: string, hooks: readonly string[] = ['onBarClose']): ModuleBundle {
  ...
  return {
    ...
    descriptor: {
      ...
      files: [{ path: 'module/index.js', sha256: '0'.repeat(64) }],
