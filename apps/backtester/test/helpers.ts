...
export function testConfig(over: Partial<AppConfig> = {}): AppConfig {
  return {
    ...
    dataApiTimeoutMs: 30_000,
    dataApiMaxAttempts: 3,
    dataApiRetryBaseMs: 500,
    dataApiRetryMaxMs: 10_000,
    dataApiMaxPages: 10_000,
    dataApiMaxRows: 5_000_000,
    dataApiOperationDeadlineMs: 0,
    pgPoolMax: 10,
