// Thin wrapper — content hashing now lives in `@trdlabs/backtester-sdk`. This re-exports the single
...
export { sha256Hex, contentRef } from '@trdlabs/backtester-sdk/contracts';
