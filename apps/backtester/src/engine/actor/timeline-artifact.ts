 ...
 *
 * Три разных отказа, и они намеренно не сведены в один: «артефакта нет», «содержимое подменено» и
 * «ссылка указывает не на тот документ» чинятся разными людьми, и общее сообщение отправило бы
 * диагноста искать не там.
 */
