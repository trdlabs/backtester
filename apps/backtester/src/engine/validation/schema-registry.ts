...
// и author-supplied paramsSchema. Сами JSON-ассеты теперь предоставляет contracts-пакет
// (@trading/research-contracts/research) через schemaAsset/allSchemaAssets — этот файл больше
