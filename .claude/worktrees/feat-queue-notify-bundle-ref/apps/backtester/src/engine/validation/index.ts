// 017 валидатор — единый источник: делегирует в kernel @trading-platform/sdk/validation (042 FU3).
...
export { validate } from '@trading-platform/sdk/validation';
export type {
  ValidationInput,
  ModuleInput,
  RunRequestInput,
  PromotionInput,
} from '@trading-platform/sdk/validation';
