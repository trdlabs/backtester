...
| File | Symbols |
|------|---------|
| `apps/backtester/src/engine/market-tape.ts` | key, map, snapshots, v, bySymbol, ... |
| `apps/backtester/src/engine/risk.ts` | evaluateAdd, limitExceeded, barIndex, AddPositionContext, openPositions, ... |
