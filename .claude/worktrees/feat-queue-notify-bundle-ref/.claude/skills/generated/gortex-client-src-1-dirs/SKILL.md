...
| `packages/client/src/client.ts` | req, raise, token, res, getRunResult, ... |
| `packages/client/src/wire.ts` | DatasetDescriptor, RunResultSummary, RunJobHandle, ArtifactPage, ArtifactManifest, ... |
