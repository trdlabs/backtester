...
| File | Symbols |
|------|---------|
| `apps/backtester/src/engine/execution.ts` | isBuy, ExecutionSimulator, computeProtectionFill, open, computeOpenFill, ... |
| `apps/backtester/src/engine/portfolio.ts` | newEntry, OpenFill, fill, newSize, fill, ... |
| `apps/backtester/src/engine/runner.ts` | fraction, calc, portfolio, symbol, hit, ... |
