...
description: "Work in the src/jobs +1 dirs · submitRun area — 41 symbols across 5 files (84% cohesion)"
---

# src/jobs +1 dirs · submitRun

41 symbols | 5 files | 84% cohesion
...
| `apps/backtester/src/jobs/job-store.ts` | idempotentReplay, JobEventRow, appendEvent, toHandle, ev, ... |
| `apps/backtester/src/jobs/pg-job-store.ts` | EventDbRow, rowToEvent, r |
| `apps/backtester/src/jobs/submit.ts` | _omitBundle, expectedKind, storedBundleHash, runId, newJob, ... |
